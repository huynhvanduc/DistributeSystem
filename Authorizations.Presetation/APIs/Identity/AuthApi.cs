using Authorizations.Presetation.Abstractions;
using Carter;
using MediatR;
...
namespace Authorizations.Presetation.APIs.Identity;
...
public class AuthApi : ApiEndpoint, ICarterModule
{
    ...
    public static async Task<IResult> AuthenticationV1(ISender sender, [FromBody] Query.Login login)
    {
