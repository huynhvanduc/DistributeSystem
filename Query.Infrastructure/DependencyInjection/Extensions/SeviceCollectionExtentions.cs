...
using Query.Infrastructure.DependencyInjecion.Options;
...
namespace Query.Infrastructure.DependencyInjection.Extensions
{
    ...
    {
        public static void ConfigureServicesInfrestructure(this IServiceCollection services, IConfiguration configuration)
        {
            services.Configure<MongoDbSettings>(configuration.GetSection(nameof(MongoDbSettings)));

            services.AddSingleton<IMongoDbSettings>(servicesProvider =>
                servicesProvider.GetRequiredService<IOptions<MongoDbSettings>>().Value);
        }
